...
#else
static struct file_operations ddr_info_ops = {
	.owner = THIS_MODULE,
	.open = ddr_info_open,
	.read  = ddr_info_read,
	.write = ddr_info_write,
};

static struct file_operations ddr_bandwidth_ops = {
	.owner = THIS_MODULE,
	.open = ddr_bandwidth_open,
	.read  = ddr_bandwidth_read,
	.write = ddr_bandwidth_write,
};
#endif
