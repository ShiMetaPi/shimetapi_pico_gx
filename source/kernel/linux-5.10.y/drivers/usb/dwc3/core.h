...
#define DWC3_PIPE_TRANS_BURST_MASK	(0xf << 8)
#define DWC3_PIPE_TRANS_BURST(x)	((x) << 8)
...
struct dwc3 {
	...
	u32		epnum_to_epidx[DWC3_ENDPOINTS_NUM];
/*
 * NOTICE: eps_directions bitmap[0~31]: 0-out ep, 1-in ep,
 * and eps_num represent with total ep numbers.
 */
