...
/**
  \brief   Get MNMIPC Register
  \details Returns the content of the MNMIPC Register.
  \return               MNMIPC Register value
 */
__ALWAYS_STATIC_INLINE uint32_t __get_MNMIPC(void)
{
    uint32_t result;

    __ASM volatile("csrr %0, mnmipc" : "=r"(result));
    return (result);
}
...
/**
  \brief   Get MNMICAUSE Register
  \details Returns the content of the MNMICAUSE Register.
  \return               MNMICAUSE Register value
 */
__ALWAYS_STATIC_INLINE uint32_t __get_MNMICAUSE(void)
{
    uint32_t result;

    __ASM volatile("csrr %0, mnmicause" : "=r"(result));
    return (result);
}
