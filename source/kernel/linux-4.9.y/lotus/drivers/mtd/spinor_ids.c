...
struct spinor_flash_dev spinor_flash_ids_lotus[] = {
	...
	{"KH25L3255E",  {0xc2, 0x9E, 0x16}, 3, SZ_4M,   SZ_64K},
	{"MX25L6406E",  {0xc2, 0x20, 0x17}, 3, SZ_8M,   SZ_64K},
	{"MX25L6456F",  {0xc2, 0x26, 0x17}, 3, SZ_8M,   SZ_64K},
	{"(MX/KH)25L128xx",  {0xc2, 0x20, 0x18}, 3, SZ_16M,  SZ_64K},
	...
	/* TODO: 4 bytes mode causes reseting failure with FPGA reset-button, so
	 * here set W25Q512NW size to 16M to force it working on 3 bytes address mode */
	{"W25Q512NW", {0xef, 0x80, 0x20}, 3, SZ_16M, SZ_64K},
#endif
	/* EoN Not support QE */
	...
	{"EN25XQ128A", {0x1c, 0x71, 0x18}, 3, SZ_16M, SZ_64K},
	...
	{"GD25Q128F", {0xC8, 0x43, 0x18}, 3, SZ_16M,  SZ_64K},
	{"GD25Q256E", {0xC8, 0x40, 0x19}, 3, SZ_32M,  SZ_64K},

	/* XMC Not support QE */
	{"XM25QH64A",  {0x20, 0x70, 0x17}, 3, SZ_8M,  SZ_64K},
	{"XM25QH64C/D", {0x20, 0x40, 0x17}, 3, SZ_8M,  SZ_64K},
	{"XM25QH128A", {0x20, 0x70, 0x18}, 3, SZ_16M, SZ_64K},
	{"XM25QH128(C/D)", {0x20, 0x40, 0x18}, 3, SZ_16M, SZ_64K},

	/* Zbit 3.3V */
	{"ZB25VQ64A",  {0x5e, 0x40, 0x17}, 3, SZ_8M,  SZ_64K},
	{"ZB25VQ128A", {0x5e, 0x40, 0x18}, 3, SZ_16M, SZ_64K},

	/* FM 3.3V */
	{"FM25Q64",    {0xa1, 0x40, 0x17}, 3, SZ_8M,  SZ_64K},
	{"FM25Q128A",  {0xa1, 0x40, 0x18}, 3, SZ_16M, SZ_64K},

	/* CFX 3.3V */
	{"GM25Q64ASIG",  {0x1c, 0x40, 0x17}, 3, SZ_8M,  SZ_64K},
	{"GM25Q128ASIG", {0x1c, 0x40, 0x18}, 3, SZ_16M, SZ_64K},

	/* NOR MEM 3.3V */
	{"NM25Q64EVB",   {0x52, 0x22, 0x17}, 3, SZ_8M,  SZ_64K},
	{"NM25Q128EVB",  {0x52, 0x21, 0x18}, 3, SZ_16M, SZ_64K},

	/* XTX 3.3v */
	{"XT25F64BSS",   {0x0B, 0x40, 0x17}, 3, SZ_8M,  SZ_64K},
	{"XT25F128BSS",  {0x0B, 0x40, 0x18}, 3, SZ_16M, SZ_64K},

	/* Puya Semiconductor 3.3V */
	{"P25Q64SH",   {0x85, 0x60, 0x17}, 3, SZ_8M,   SZ_64K},
	{"P25Q128H",   {0x85, 0x60, 0x18}, 3, SZ_16M,  SZ_64K},
	{"PY25Q64HA",  {0x85, 0x20, 0x17}, 3, SZ_8M,   SZ_64K},
	{"PY25Q128HA", {0x85, 0x20, 0x18}, 3, SZ_16M,  SZ_64K},
	{ NULL, },
};
