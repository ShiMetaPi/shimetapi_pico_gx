...
#ifndef _CORE_RV32_H_
#define _CORE_RV32_H_
 ...
 */
__STATIC_INLINE void rv32_vic_enable_irq(int32_t IRQn)
{
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void rv32_vic_disable_irq(int32_t IRQn)
{
    CLIC->CLICINT[IRQn].IE &= ~CLIC_INTIE_IE_Msk;
}
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void rv32_vic_enable_sirq(int32_t IRQn)
{
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void rv32_vic_disable_sirq(int32_t IRQn)
{
    CLIC->CLICINT[IRQn].IE &= ~(CLIC_INTIE_IE_Msk | CLIC_INTIE_T_Msk);
}
 ...
 */
__STATIC_INLINE uint32_t rv32_vic_get_enabled_irq(int32_t IRQn)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_vic_get_pending_irq(int32_t IRQn)
{
 ...
 */
__STATIC_INLINE void rv32_vic_set_pending_irq(int32_t IRQn)
{
...
/**
  ...
  \param [in]      IRQn  External interrupt number. Value cannot be negative.
 */
__STATIC_INLINE void rv32_vic_clear_pending_irq(int32_t IRQn)
{
    CLIC->CLICINT[IRQn].IP &= ~CLIC_INTIP_IP_Msk;
}
 ...
 */
__STATIC_INLINE void rv32_vic_set_prio(int32_t IRQn, uint32_t priority)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_vic_get_prio(int32_t IRQn)
{
    uint8_t nlbits = (CLIC->CLICINFO & CLIC_INFO_CLICINTCTLBITS_Msk) >> CLIC_INFO_CLICINTCTLBITS_Pos;
...
/**
  ...
  \return             Interrupt thresh value(0~255).
                      Value is aligned automatically to the implemented priority bits of the microcontroller.
 */
__STATIC_INLINE uint32_t rv32_vic_get_thresh(void)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_vic_set_thresh(uint32_t thresh)
{
 ...
 */
__STATIC_INLINE void rv32_vic_set_vector(int32_t IRQn, uint32_t handler)
{
    if (IRQn >= 0 && IRQn < 1024) {
...
/**
  ...
  \param [in]      IRQn  Interrupt number.
 */
__STATIC_INLINE uint32_t rv32_vic_get_vector(int32_t IRQn)
{
    if (IRQn >= 0 && IRQn < 1024) {
        uint32_t *vectors = (uint32_t *)__get_MTVT();
...
/**
  ...
  */
__STATIC_INLINE void rv32_mpu_config_region(uint32_t idx, uint32_t base_addr, region_size_e size,
...
/**
  ...
  \param [in]  idx        memory protected region (0, 1, 2, ..., 15).
  */
__STATIC_INLINE void rv32_mpu_disable_region(uint32_t idx)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_coret_config(uint32_t ticks, int32_t IRQn)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_coret_get_load(void)
{
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint32_t rv32_coret_get_loadh(void)
{
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint32_t rv32_coret_get_value(void)
{
...
/**
  ...
  \return          CORE timer counter value.
 */
__STATIC_INLINE uint32_t rv32_coret_get_valueh(void)
{
...
/**
  ...
  \param [in]  enable     enable or disable memory protected region.
  */
__STATIC_INLINE void rv32_sysmap_config_region(uint32_t idx, uint32_t base_addr, uint32_t attr)
{
    uint32_t addr = 0;
 ...
 */
__STATIC_INLINE uint32_t rv32_had_send_char(uint32_t ch)
{
 ...
 */
__STATIC_INLINE int32_t rv32_had_receive_char(void)
{
 ...
 */
__STATIC_INLINE int32_t rv32_had_check_char(void)
{
...
/**
  ...
  */
__STATIC_INLINE void rv32_system_reset (void)
{
    uint32_t mexstatus;
...
/**
  ...
  */
__STATIC_INLINE void rv32_core_reset (void)
{
    uint32_t mexstatus;
    mexstatus = __get_MEXSTATUS();
    mexstatus &= (~(MEXSTATUS_RESET_Msk));
...
/**
  ...
  */
__STATIC_INLINE void rv32_icache_enable (void)
{
...
/**
  ...
  */
__STATIC_INLINE void rv32_icache_disable (void)
{
#if (__ICACHE_PRESENT == 1U)
    uint32_t cache;
    __DSB();
...
/**
  ...
  */
__STATIC_INLINE void rv32_icache_invalid (void)
{
#if (__ICACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
/**
  ...
  */
__STATIC_INLINE void rv32_dcache_enable (void)
{
    ...
    cache = __get_MHCR();
    cache |= (CACHE_MHCR_DE_Msk | CACHE_MHCR_WA_Msk | CACHE_MHCR_RS_Msk | CACHE_MHCR_BPE_Msk | CACHE_MHCR_L0BTB_Msk);      /* enable all Cache */
    cache &= ~CACHE_MHCR_WB_Msk; /* Use write-through mode as the openE906 may not support T-HEAD Ext instructions, no cache operation instruction is available */
    __set_MHCR(cache);
...
/**
  ...
  */
__STATIC_INLINE void rv32_dcache_disable (void)
{
#if (__DCACHE_PRESENT == 1U)
    uint32_t cache;
    __DSB();
...
/**
  ...
  */
__STATIC_INLINE void rv32_dcache_invalid (void)
{
#if (__DCACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
/**
  ...
  */
__STATIC_INLINE void rv32_dcache_clean (void)
{
#if (__DCACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
/**
  ...
  */
__STATIC_INLINE void rv32_dcache_clean_invalid (void)
{
#if (__DCACHE_PRESENT == 1U)
    __DSB();
    __ISB();
...
*/
__STATIC_INLINE void rv32_dcache_invalid_range (uint32_t *addr, int32_t dsize)
{
#if (__DCACHE_PRESENT == 1U)
...
/**
  ...
  \param[in]   dsize   size of memory block (in number of bytes)
*/
__STATIC_INLINE void rv32_dcache_clean_range (uint32_t *addr, int32_t dsize)
{
...
*/
__STATIC_INLINE void rv32_dcache_clean_invalid_range (uint32_t *addr, int32_t dsize)
{
#if (__DCACHE_PRESENT == 1U)
    int32_t op_size = dsize + (uint32_t)addr % 32;
    uint32_t op_addr = (uint32_t) addr;
...
/**
  ...
  */
__STATIC_INLINE void rv32_cache_set_range (uint32_t index, uint32_t baseAddr, uint32_t size, uint32_t enable)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void rv32_cache_enable_profile (void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void rv32_cache_disable_profile (void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE void rv32_cache_reset_profile (void)
{
    ;
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t rv32_cache_get_access_time (void)
{
    return 0;
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t rv32_cache_get_miss_time (void)
{
    return 0;
}
 ...
 */
__STATIC_INLINE void rv32_itcm_enable (void)
{
 ...
 */
__STATIC_INLINE void rv32_dtcm_enable (void)
{
...
/**
 ...
 \details Turns on ITCM
 */
__STATIC_INLINE void rv32_itcm_disable (void)
{
    __set_MITCMCR(__get_MITCMCR() & (~MITCMCR_EN_Msk));
}
...
/**
 ...
 \details Turns on DTCM
 */
__STATIC_INLINE void rv32_dtcm_disable (void)
{
    __set_MDTCMCR(__get_MDTCMCR() & (~MDTCMCR_EN_Msk));
}
 ...
 */
__STATIC_INLINE uint32_t rv32_itcm_get_size(void)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_dtcm_get_size(void)
{
 ...
 */
__STATIC_INLINE void rv32_itcm_set_base_addr(uint32_t base_addr)
{
 ...
 */
__STATIC_INLINE void rv32_dtcm_set_base_addr(uint32_t base_addr)
{
 ...
 */
__STATIC_INLINE uint32_t rv32_irq_save(void)
{
    uint32_t result;
 ...
 */
__STATIC_INLINE void rv32_irq_restore(uint32_t irq_state)
{
