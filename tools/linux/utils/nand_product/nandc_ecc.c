...
void ecc_1bit_gen(unsigned char *data, unsigned int len, unsigned char *ecc_code)
{
	...
	memset(enc_data_last, 0x1, ENC_DATA_LEN);

	for (i = 0; i < len; i++)
	{
		make_ecc_1bit(i, data[i], enc_data, enc_data_last);
		memcpy(enc_data_last, enc_data, ENC_DATA_LEN);
	}
...
#define ECC_BUF_LEN 14
#define PAGE_BUF_LEN1 14
#define PAGE_BUF_LEN2 994
#define PAGE_BUF_LEN3 2
#define PAGE_BUF_LEN4 30
#define PAGE_BUF_LEN5 1032
#define PAGE_BUF_LEN6 958
#define PAGE_BUF_LEN7 42
#define PAGE_BUF_LEN8 28
#define PAGE_BUF_LEN9 992
#define PAGE_BUF_LEN10 6
#define PAGE_BUF_LEN11 1028
#define PAGE_BUF_LEN12 928
#define PAGE_BUF_LEN13 84
#define PAGE_BUF_LEN14 966
#define PAGE_BUF_LEN15 874
#define PAGE_BUF_LEN16 126
#define PAGE_BUF_LEN17 702
#define PAGE_BUF_LEN18 294
#define PAGE_BUF_LEN19 70
#define PAGE_BUF_LEN20 506
#define PAGE_BUF_LEN21 490
#define PAGE_BUF_LEN22 1026
#define PAGE_BUF_LEN23 56
#define PAGE_BUF_LEN24 994
#define PAGE_BUF_LEN25 112
#define PAGE_BUF_LEN26 212
#define PAGE_BUF_LEN27 784
#define PAGE_BUF_LEN28 452
#define PAGE_BUF_LEN29 574
...
int page_ecc_gen(unsigned char *pagebuf, enum page_type pagetype, enum ecc_type ecctype)
{
	...
	{
		unsigned char ecc_buf[ECC_BUF_LEN];
