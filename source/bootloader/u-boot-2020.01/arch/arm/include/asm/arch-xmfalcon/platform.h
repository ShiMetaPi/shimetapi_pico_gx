...
/* -------------------------------------------------------------------- */
#define REG_BASE_SF		0x11900000
#define GMAC_REG_BASE		0x11900000
/* -------------------------------------------------------------------- */
...
#define USB3_CTRL_REG_BASE	0x10040000
...
#define MAX_VER_ID_NUM	10
#define MAX_CAPS_NUM	5
#define MAX_CAP_ITEM_NUM 6

#define REG_PERI_CRG292	(CRG_REG_BASE + 0x490)
#define REG_PERI_CRG293	(CRG_REG_BASE + 0x494)
#define REG_PERI_CRG294	(CRG_REG_BASE + 0x498)
#define REG_PERI_CRG295	(CRG_REG_BASE + 0x49c)

#define REG_MISC_CTRL77		(SYS_CTRL_REG_BASE + 0x8804)
#define REG_MISC_CTRL79		(SYS_CTRL_REG_BASE + 0x880C)
...
#define MCU_SRAM_BASE	0x4020000
