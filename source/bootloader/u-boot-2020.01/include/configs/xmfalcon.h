...
#define CONFIG_PRODUCTNAME "xmfalcon"
...
#define CONFIG_LOTUS_SDHCI_MAX_FREQ  200000000
...
#define CONFIG_LBIST_TEST_PATTERN_OFF_POS  (CONFIG_MCU_FW_AREA_LEN_POS + 0x4)
#define COFNIG_LBIST_TEST_PATTERN_LEN_POS  (CONFIG_LBIST_TEST_PATTERN_OFF_POS + 0x4)
#define COFNIG_LBIST_TEST_PATTERN_HASH_POS (COFNIG_LBIST_TEST_PATTERN_LEN_POS + 0x4)
#define COFNIG_AUXCODE_ALG_FLAG_POS        (COFNIG_LBIST_TEST_PATTERN_HASH_POS + 0x20)
#define CONFIG_RESERVED0_POS               (COFNIG_AUXCODE_ALG_FLAG_POS + 0x4)
...
#define CONFIG_RESERVED0_LEN               (0x154)
...
#define CONFIG_AUXAREA_LEN              0x7000      /* 28k for auxcode total len    */
#endif
...
#define CONFIG_BL31_BASE		(CONFIG_SYS_SDRAM_BASE + 0x8000)
#define CONFIG_BL31_LIMIT		(CONFIG_BL31_BASE + 0x40000) //256K limit
#define CONFIG_BL32_BASE		(CONFIG_SYS_SDRAM_BASE + 0x10000000)

#define CONFIG_MCU_FW_BUF_ADDR		CONFIG_BL31_LIMIT
...
initial page tables. we limit the max dtb size to 128K, which is
a safe and enough size for dtb.
*/
