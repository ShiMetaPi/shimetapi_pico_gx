...
#endif
#ifdef GENERATOR_FILE
extern int riscv_insn_dread_vlenb;
#else
  int x_riscv_insn_dread_vlenb;
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_insn_dvsetvl_globally;
#else
  int x_riscv_insn_dvsetvl_globally;
#define riscv_insn_dvsetvl_globally global_options.x_riscv_insn_dvsetvl_globally
#endif
#ifdef GENERATOR_FILE
extern int riscv_insn_dvsetvl_v0p7;
#else
  int x_riscv_insn_dvsetvl_v0p7;
#define riscv_insn_dvsetvl_v0p7 global_options.x_riscv_insn_dvsetvl_v0p7
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_insn_dvsetvl2;
#else
  int x_riscv_insn_dvsetvl2;
#define riscv_insn_dvsetvl2 global_options.x_riscv_insn_dvsetvl2
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_load_merging;
#else
  int x_riscv_load_merging;
#define riscv_load_merging global_options.x_riscv_load_merging
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int riscv_rnreg_delete_noop_move;
#else
  int x_riscv_rnreg_delete_noop_move;
#define riscv_rnreg_delete_noop_move global_options.x_riscv_rnreg_delete_noop_move
#endif
#ifdef GENERATOR_FILE
...
#define MASK_DSP (1U << 9)
#define MASK_HARD_FLOAT (1U << 10)
#define MASK_MUL (1U << 11)
#define MASK_RVC (1U << 12)
#define MASK_RVE (1U << 13)
#define MASK_RVZFH (1U << 14)
#define MASK_VECTOR (1U << 15)
#define MASK_XTHEAD (1U << 16)
#define MASK_XTHEAD_C (1U << 17)
#define MASK_XTHEAD_E (1U << 18)
#define MASK_XTHEAD_SE (1U << 19)
#define MASK_XTHEAD_V (1U << 20)
#define MASK_ZPN (1U << 21)
#define MASK_ZPRVSFEXTRA (1U << 22)
#define MASK_ZPSFOPERAND (1U << 23)
...
#define TARGET_XTHEAD_V ((target_flags & MASK_XTHEAD_V) != 0)
#define TARGET_ZPN ((target_flags & MASK_ZPN) != 0)
#define TARGET_ZPRVSFEXTRA ((target_flags & MASK_ZPRVSFEXTRA) != 0)
...
enum opt_code
{
  ...
  OPT_mdelete_read_vlenb = 1610,             /* -mdelete-read-vlenb */
  OPT_mdelete_sext = 1611,                   /* -mdelete-sext */
  OPT_mdelete_sext2 = 1612,                  /* -mdelete-sext2 */
  OPT_mdelete_vsetvl = 1613,                 /* -mdelete-vsetvl */
  OPT_mdelete_vsetvl_globally = 1614,        /* -mdelete-vsetvl-globally */
  OPT_mdelete_vsetvl_v0p7 = 1615,            /* -mdelete-vsetvl-v0p7 */
  OPT_mdelete_vsetvl_zero = 1616,            /* -mdelete-vsetvl-zero */
  OPT_mdelete_vsetvl_zero_bbs = 1617,        /* -mdelete-vsetvl-zero-bbs */
  OPT_mdelete_vsetvl2 = 1618,                /* -mdelete-vsetvl2 */
  OPT_mdiv = 1619,                           /* -mdiv */
  OPT_mdup_loop_header = 1620,               /* -mdup-loop-header */
  OPT_mexpand_split_imm = 1621,              /* -mexpand-split-imm */
  OPT_mexplicit_relocs = 1622,               /* -mexplicit-relocs */
  OPT_mext = 1623,                           /* -mext */
  OPT_mfclass = 1624,                        /* -mfclass */
  OPT_mfdiv = 1625,                          /* -mfdiv */
  OPT_mfldr = 1626,                          /* -mfldr */
  OPT_mfmvhw32 = 1627,                       /* -mfmvhw32 */
  OPT_mfp16 = 1628,                          /* -mfp16 */
  ...
  OPT_mldi = 1635,                           /* -mldi */
  OPT_mldr = 1636,                           /* -mldr */
  OPT_mload_merging = 1637,                  /* -mload-merging */
  OPT_mmove_loop_vsetvl = 1638,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1639,                          /* -mmula */
  OPT_mplt = 1640,                           /* -mplt */
  ...
  OPT_mxor_combine = 1657,                   /* -mxor-combine */
  OPT_n = 1658,                              /* -n */
  OPT_name_sort = 1659,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1660,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1661,              /* -no-integrated-cpp */
  OPT_no_pie = 1662,                         /* -no-pie */
  OPT_nocpp = 1663,                          /* -nocpp */
  OPT_nodefaultlibs = 1664,                  /* -nodefaultlibs */
  OPT_nolibc = 1665,                         /* -nolibc */
  OPT_nophoboslib = 1666,                    /* -nophoboslib */
  OPT_nostartfiles = 1667,                   /* -nostartfiles */
  OPT_nostdinc = 1668,                       /* -nostdinc */
  OPT_nostdinc__ = 1669,                     /* -nostdinc++ */
  OPT_nostdlib = 1670,                       /* -nostdlib */
  OPT_o = 1671,                              /* -o */
  OPT_objects = 1672,                        /* -objects */
  OPT_p = 1673,                              /* -p */
  OPT_pass_exit_codes = 1674,                /* -pass-exit-codes */
  /* OPT_pedantic = 1675, */                 /* -pedantic */
  OPT_pedantic_errors = 1676,                /* -pedantic-errors */
  OPT_pg = 1677,                             /* -pg */
  OPT_pie = 1678,                            /* -pie */
  OPT_pipe = 1679,                           /* -pipe */
  ...
  OPT_r = 1693,                              /* -r */
  OPT_remap = 1694,                          /* -remap */
  OPT_reverse_sort = 1695,                   /* -reverse-sort */
  OPT_s = 1696,                              /* -s */
  OPT_save_temps = 1697,                     /* -save-temps */
  OPT_save_temps_ = 1698,                    /* -save-temps= */
  OPT_shared = 1699,                         /* -shared */
  OPT_shared_libgcc = 1700,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1701,               /* -shared-libphobos */
  OPT_size_sort = 1702,                      /* -size-sort */
  /* OPT_specs = 1703, */                    /* -specs */
  OPT_specs_ = 1704,                         /* -specs= */
  OPT_static = 1705,                         /* -static */
  OPT_static_libasan = 1706,                 /* -static-libasan */
  OPT_static_libgcc = 1707,                  /* -static-libgcc */
  OPT_static_libgfortran = 1708,             /* -static-libgfortran */
  OPT_static_libgo = 1709,                   /* -static-libgo */
  OPT_static_liblsan = 1710,                 /* -static-liblsan */
  OPT_static_libmpx = 1711,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1712,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1713,               /* -static-libphobos */
  OPT_static_libstdc__ = 1714,               /* -static-libstdc++ */
  OPT_static_libtsan = 1715,                 /* -static-libtsan */
  OPT_static_libubsan = 1716,                /* -static-libubsan */
  OPT_static_pie = 1717,                     /* -static-pie */
  /* OPT_std_c__03 = 1718, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1719, */                /* -std=c++0x */
  OPT_std_c__11 = 1720,                      /* -std=c++11 */
  OPT_std_c__14 = 1721,                      /* -std=c++14 */
  OPT_std_c__17 = 1722,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1723, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1724, */                /* -std=c++1z */
  /* OPT_std_c__20 = 1725, */                /* -std=c++20 */
  OPT_std_c__2a = 1726,                      /* -std=c++2a */
  OPT_std_c__98 = 1727,                      /* -std=c++98 */
  OPT_std_c11 = 1728,                        /* -std=c11 */
  OPT_std_c17 = 1729,                        /* -std=c17 */
  /* OPT_std_c18 = 1730, */                  /* -std=c18 */
  /* OPT_std_c1x = 1731, */                  /* -std=c1x */
  OPT_std_c2x = 1732,                        /* -std=c2x */
  /* OPT_std_c89 = 1733, */                  /* -std=c89 */
  OPT_std_c90 = 1734,                        /* -std=c90 */
  OPT_std_c99 = 1735,                        /* -std=c99 */
  /* OPT_std_c9x = 1736, */                  /* -std=c9x */
  OPT_std_f2003 = 1737,                      /* -std=f2003 */
  OPT_std_f2008 = 1738,                      /* -std=f2008 */
  OPT_std_f2008ts = 1739,                    /* -std=f2008ts */
  OPT_std_f2018 = 1740,                      /* -std=f2018 */
  OPT_std_f95 = 1741,                        /* -std=f95 */
  OPT_std_gnu = 1742,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1743, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1744, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1745,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1746,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1747,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1748, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1749, */              /* -std=gnu++1z */
  /* OPT_std_gnu__20 = 1750, */              /* -std=gnu++20 */
  OPT_std_gnu__2a = 1751,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1752,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1753,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1754,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1755, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1756, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1757,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1758, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1759,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1760,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1761, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1762, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1763,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1764, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1765, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1766, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1767, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1768, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1769,                     /* -std=legacy */
  OPT_symbol_ = 1770,                        /* -symbol= */
  OPT_symbolic = 1771,                       /* -symbolic */
  OPT_t = 1772,                              /* -t */
  OPT_time = 1773,                           /* -time */
  OPT_time_ = 1774,                          /* -time= */
