 ...
 *****************************************************************************/
#pragma weak plat_lotus_gic_driver_init
#pragma weak plat_lotus_gic_init
#pragma weak plat_lotus_gic_cpuif_enable
#pragma weak plat_lotus_gic_cpuif_disable
#pragma weak plat_lotus_gic_pcpu_init

/******************************************************************************
 * On a GICv2 system, the Group 1 secure interrupts are treated as Group 0
 * interrupts.
 *****************************************************************************/
static const interrupt_prop_t lotus_interrupt_props[] = {
	/* PLAT_LOTUS_G1S_IRQ_PROPS(GICV2_INTR_GROUP0),
	 * PLAT_LOTUS_G0_IRQ_PROPS(GICV2_INTR_GROUP0) */
};

static unsigned int target_mask_array[PLATFORM_CORE_COUNT];

static const gicv2_driver_data_t lotus_gic_data = {
	.gicd_base = PLAT_LOTUS_GICD_BASE,
	.gicc_base = PLAT_LOTUS_GICC_BASE,
	.interrupt_props = lotus_interrupt_props,
	.interrupt_props_num = ARRAY_SIZE(lotus_interrupt_props),
...
{
	gicv2_driver_init(&lotus_gic_data);
}
 ...
 *****************************************************************************/
void plat_lotus_gic_redistif_on(void)
{
	return;
}

void plat_lotus_gic_redistif_off(void)
{
	return;
}
...
void plat_lotus_gic_resume(void)
{
	gicv2_distif_init();
	gicv2_pcpu_distif_init();
	gicv2_set_pe_target_mask(plat_my_core_pos());
