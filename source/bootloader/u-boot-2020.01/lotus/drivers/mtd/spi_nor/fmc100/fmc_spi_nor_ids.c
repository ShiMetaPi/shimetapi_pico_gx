...
set_read_quad_dtr(10, INFINITE, 80);
...
#include "fmc100_spi_xmc.c"
static struct spi_drv spi_driver_xm25qh128d = {
	.wait_ready = spi_general_wait_ready,
	.write_enable = spi_general_write_enable,
	.entry_4addr = spi_general_entry_4addr,
	.qe_enable = spi_general_qe_enable,
#ifdef CONFIG_DTR_MODE_SUPPORT
	.dtr_set_device =
	spi_xmc_output_driver_strength_set,
#endif
};
...
#ifdef CONFIG_DTR_MODE_SUPPORT
	.dtr_set_device =
	spi_gd_output_driver_strength_set,
#endif
};
...
static struct spi_nor_info fmc_spi_nor_info_table[] = {
	...
	/* MX25L12835F/KH25L12833FM2I/MX25L12845G,  The suffix "45G" indicates the flash supporting DTR mode */
	{
		"(MX/KH)25L128XX", {0xc2, 0x20, 0x18}, 3, _16M, _64K, 3,
		{
			&read_std(0, INFINITE, 50), /* 50MHz */
	...
	/* winbond W25Q128JVEAQ  3.3v */
	{
		"W25Q128(B/F)V", {0xEF, 0x40, 0x18}, 3, _16M, _64K, 3,
		{
			...
			&read_fast(1, INFINITE, 104), /* 104MHz */
			&read_dual(1, INFINITE, 104), /* 104MHz */
			&read_quad(1, INFINITE, /* 80 */ 104), /* 104MHz */
			0
		},
	...
	/* Winbond W25Q512NW-IM  1.8V */
	{
		"W25Q512NW-IM", {0xEF, 0x80, 0x20}, 3, _64M, _64K, 4,
		{
			&read_std4b(0, INFINITE, 50),
			&read_fast4b(1, INFINITE, 133),
			&read_dual4b(1, INFINITE, 133),
	...
	/* GD GD25Q128F 3/3V */
	{
		"GD25Q128F", {0xC8, 0x43, 0x18}, 3, _16M,  _64K, 3,
		{
			&read_std(0, INFINITE, 80), /* 80MHz */
			&read_fast(1, INFINITE, 80), /* 80MHz */
			&read_dual(1, INFINITE, 80), /* 80MHz */
			&read_dual_addr(1, INFINITE, 80), /* 804MHz */
			&read_quad(1, INFINITE, 80), /* 80MHz */
			&read_quad_addr(3, INFINITE, 80), /* 80MHz */
			0
		},
	...
	/* GD GD25Q128/GD25Q127 3/3V */
	{
		"GD25Q12XX", {0xC8, 0x40, 0x18}, 3, _16M,  _64K, 3,
		{
			...
			&read_quad_addr(3, INFINITE, 104), /* 104MHz */
#ifdef CONFIG_DTR_MODE_SUPPORT
			&read_quad_dtr(10, INFINITE, 80 ), /* 80MHz */
#endif
			0
		},
		{
	...
	/* XMC XM25QH64CHIQ 3.3v DTR max 80MHz*/
	{
		"XM25QH64C/D", {0x20, 0x40, 0x17}, 3, _8M,  _64K, 3,
		{
			&read_std(0, INFINITE, 50), /* 50MHz */
			&read_fast(1, INFINITE, 133), /* 133MHz */
			&read_dual(1, INFINITE, 133), /* 133MHz */
			...
			&read_quad_addr(3, INFINITE, 133), /* 133MHz */
#ifdef CONFIG_DTR_MODE_SUPPORT
			&read_quad_dtr(8, INFINITE, 80 ), /* 100MHz */
#endif
			0
		},
		{
	...
	{
		"XM25QH128(C/D)", {0x20, 0x40, 0x18}, 3, _16M,  _64K, 3,
		{
			&read_std(0, INFINITE, 50), /* 50MHz */
			&read_fast(1, INFINITE, 133), /* 133MHz */
			&read_dual(1, INFINITE, 133), /* 133MHz */
			...
			&read_quad(1, INFINITE, 133), /* 133MHz */
#ifdef CONFIG_DTR_MODE_SUPPORT
			&read_quad_dtr(10, INFINITE, 100 ), /* 100MHz */
#endif
			0
		},
		{
	...
	/* PY25Q64HA 3.3V */
	{
		"PY25Q64HA", {0x85, 0x20, 0x17}, 3, _8M,  _64K, 3,
		{
			&read_std(0, INFINITE, 45),
			&read_fast(1, INFINITE, 104),
			&read_dual(1, INFINITE, 104),
