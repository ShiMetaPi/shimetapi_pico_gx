...
#define FMC_GLOBAL_CFG_WP_ENABLE        BIT(11)
#define FMC_GLOBAL_CFG_RANDOMIZER_EN    (1 << 24)
#define FLASH_TYPE_SEL_MASK             (0x3 << 3)
#define FMC_CFG_FLASH_SEL(_type)        (((_type) & 0x3) << 3)

#define FMC_GLOBAL_CFG_DTR_MODE          BIT(2)
/*****************************************************************************/
#define FMC_SPI_TIMING_CFG               0x00
#define TIMING_CFG_TCSH(nr)             (((nr) & 0xf) << 8)
#define TIMING_CFG_TCSS(nr)             (((nr) & 0xf) << 0)
#define TIMING_CFG_TSHSL(nr)            (((nr) & 0xf) << 4)
...
#define FM_BP_ENABLE(_val)         ((PROTECT_BP2_MASK & _val) \
                        || (PROTECT_BP1_MASK & _val) \
                        || (PROTECT_BP0_MASK & _val))
...
#define FM_BP_MASK       (PROTECT_BP2_MASK \
                        | PROTECT_BP1_MASK \
                        | PROTECT_BP0_MASK)
...
#define FMC_OP_CMD1_EN              BIT(2)
#define FMC_OP_ADDR_EN              BIT(1)
#define FMC_OP_WRITE_DATA_EN            BIT(5)
#define FMC_OP_CMD2_EN              BIT(4)
#define FMC_OP_WAIT_READY_EN            BIT(3)
#define FMC_OP_READ_DATA_EN         BIT(7)
#define FMC_OP_READ_STATUS_EN           BIT(6)
...
#define OP_CTRL_RD_OPCODE(code)     (((code) & 0xff) << 8)
#define OP_CTRL_WR_OPCODE(code)     (((code) & 0xff) << 16)
