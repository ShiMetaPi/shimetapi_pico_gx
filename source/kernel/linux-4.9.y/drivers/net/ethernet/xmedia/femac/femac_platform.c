		  ...
		  struct femac_priv *priv)
{
	...
	if (of_device_is_compatible(node, "xmedia,femac-v2"))
...
static int femac_drv_probe(struct platform_device *pdev)
{
	...
	chip_id = get_chipid();
	if ((chip_id == CHIPID_XM72020330) || (chip_id == CHIPID_XM72020300))
		return 0;
...
MODULE_DESCRIPTION("Xmedia Fast Ethernet MAC driver");
