...
SET_READ_QUAD_ADDR(2, INFINITE, 133);
...
static struct spi_drv spi_driver_general = {
	...
	.disable_protect = spi_general_disable_protect,
	.disable_ecc = spi_general_disable_ecc,
};

static struct spi_drv spi_driver_fm = {
	.wait_ready = spi_general_wait_ready,
	.write_enable = spi_general_write_enable,
	.qe_enable = spi_general_qe_enable,
	.disable_protect = spi_fm_disable_protect,
	.disable_ecc = spi_fm_disable_ecc,
};
...
static struct spi_drv spi_driver_hy = {
	.wait_ready = spi_general_wait_ready,
	.write_enable = spi_general_write_enable,
	.qe_enable = spi_general_qe_enable,
	.disable_protect = spi_fm_disable_protect,
...
struct spi_nand_info fmc_spi_nand_flash_table[] = {
	...
	/* MXIC MX35UF4GE4AD 4Gbit 1.8V */
	{
		...
		.read      = {
			...
			&READ_QUAD_ADDR(2, INFINITE, 133), /* 133MHz */
			0
		},
		.write     = {
			&WRITE_STD(0, 256, 24),  /* 24MHz */
	...
	/* FM 3.3v FM25S02B 1Gbit */
	{
		...
		.driver    = &spi_driver_fm,
	},
	/* FORESEE 3.3V F35SQA001G 1Gb */
	{
		.name      = "F35SQA001G",
		.id        = {0xcd, 0x71},
		.id_len    = 2,
				   ...
				   struct spi_nand_info *spi_dev)
{
	...
	spi->driver->disable_protect(spi);
	spi->driver->disable_ecc(spi);
