...
int osal_isdigit(int c)
{
        return isdigit(c);
}
EXPORT_SYMBOL(osal_isdigit);

#ifdef CONFIG_KERNEL_MODE_NEON
void osal_kernel_neon_begin(void)
{
        kernel_neon_begin();
}
EXPORT_SYMBOL(osal_kernel_neon_begin);

void osal_kernel_neon_end(void)
{
        kernel_neon_end();
}
EXPORT_SYMBOL(osal_kernel_neon_end);
#endif
