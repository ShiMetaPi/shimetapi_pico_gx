...
#define SPINOR_OP_READ_QUAD_ADDR  0xEB /* Fast Read Quad I/O  **/
...
#define SPINOR_OP_PP_QUAD_4B   0x34 /* Quad Page program (up to 256 bytes) with 4 byte address */
...
#define SPINOR_STATUS2_EQ_NM   0x04 /* Quad Enable, NOR MEM */
