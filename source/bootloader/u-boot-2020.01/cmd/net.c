...
/* Support tftp short cmd when CONFIG_CMD_TFTPPUT enabled */
int do_tftp(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
	int ret;
	...
	ret = do_tftpb(cmdtp, flag, argc, argv);
out:
	return ret;
}
