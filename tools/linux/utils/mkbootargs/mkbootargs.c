...
int main(int argc, char *argv[])
{
	...
	if (argc < 2) {
		printf("\r\nUsage: mkbootargs [-s Size] [-r Input File] [-o Output File] :\n"
		       ...
		       "       -s Size: Boot Env size in Byte, usually, equal to the bootargs partition size. default '512'.\n"
		       "\r\nmkbootargs will read 'Input File' and create 'Output File'.\n");
		printf("\r\nExample:./makebootargs -s 0x40000 -r bootargs_input.txt -o bootargs.bin\n\n");
		return 1;
	}
