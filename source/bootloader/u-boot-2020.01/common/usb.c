...
int usb_string(struct usb_device *dev, int index, char *buf, size_t size)
{
	...
	/*
	 * Some u-storage seem to need delay to prepare desc data that
	 * send to host, otherwise recognized failed.This is effective
	 * for TECLAST 32GB USB 2.0 and MOVE-SPEED 32GB USB2.0 so far.
	 */
	mdelay(1);
#endif
