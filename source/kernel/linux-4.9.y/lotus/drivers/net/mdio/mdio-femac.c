...
#define PHY_RESET_DELAYS_PROPERTY	"lotus,phy-reset-delays-us"
...
struct lotus_fephy_private fephy_private;
...
MODULE_DESCRIPTION("Lotus Fast Ethernet MAC MDIO interface driver");
